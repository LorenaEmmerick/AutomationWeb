...
@ST1C1
  Cenário: Consulta de produtos no site em lista com sucesso
...
@ST1C2
  Cenário: Consulta de produtos no site em grid com sucesso
    Dado os itens para pesquisa são:
      |item                        |quantidadeItem             |paginacao               |
...
@ST1C3
  Cenário: Consulta de produtos no site sem sucesso 
    Dado os itens para pesquisa são:
      |item         |quantidadeItem             |alerta                                        |
      |Sapato       |0 results have been found. |No results were found for your search "Sapato"|
    E que sou um usuário na página do site
    Quando faço a pesquisa com o item
    Então não posso visualizar nenhum item 
    E vejo o alerta de resultados não encontrados com o nome do item